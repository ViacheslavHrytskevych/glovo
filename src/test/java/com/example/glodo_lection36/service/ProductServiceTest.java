...
public class ProductServiceTest {
    ...
    private ProductRepository productRepository;  // декларируем репозиторий от которого он зависит
    private ProductService productService;  // декларируем класс, который хотим тестировать

    @BeforeEach
    public void setUp() {
        productRepository = Mockito.mock(ProductRepository.class);  // Mockito.mock  можно заменить аннотацией @Mockito перед классом
